...
const GasHeater = () => {
  ...
  return (
    <GasServiceLayout
      ...
      description="Professional gas heater installation, maintenance, and repair services. We ensure your heating system operates safely and efficiently."
    >
        ...
        <div>
          ...
          <div className="bg-teal-50 p-4 rounded-lg mb-4">
            ...
            <ul className="list-disc list-inside space-y-1.5 text-gray-700">
              <li>Professional heater installation</li>
              ...
              <li>Heating efficiency checks</li>
            </ul>
          </div>
