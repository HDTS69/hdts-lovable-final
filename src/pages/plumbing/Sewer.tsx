          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Professional sewer and drain solutions for your property. From routine maintenance to emergency repairs, we ensure your sewer system operates efficiently and reliably.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-teal-50 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h2 className="text-xl font-semibold text-teal-700">Our Sewer Services</h2>
                  </div>
                  <ul className="space-y-1.5 text-gray-600">
                    ...
                    <li>• Root Intrusion Solutions</li>
